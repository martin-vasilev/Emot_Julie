...
for ID in range(1, 52):
    ...
    S2= [3, 6, 9, 12, 15, 18, 21, 24, 27, 30, 33, 36, 39, 42, 45, 48, 51]
    ...
    c= list(zip(item, cond, emot))
    
    # randomise:
    from random import shuffle
    shuffle(c)
    pract= [(73, 9, 'PRAC'), (74, 9, 'PRAC'), (75, 9, 'PRAC'), (76, 9, 'PRAC'), (77, 9, 'PRAC'), (78, 9, 'PRAC')]
    shuffle(pract)
    design= pract+ c
    print(design)
    	
    thefile = open('Design/P'+ str(ID)+ '.txt', 'w')
    thefile.write("item cond emot\n") # columns
